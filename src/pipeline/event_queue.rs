...
use engine::crossbeam::channel::Receiver;
use engine::geometry::{CollisionEvent, ContactForceEvent};
use engine::pipeline::ChannelEventCollector;
...
impl RawEventQueue {
    ...
    pub fn new(autoDrain: bool) -> Self {
        let collision_channel = engine::crossbeam::channel::unbounded();
        let contact_force_channel = engine::crossbeam::channel::unbounded();
